...
# The following file is included in the source package. Maybe you have to copy it from the source and adjust the
# directory anyway, namely if you have downloaded just the examples separated from the other source files.
