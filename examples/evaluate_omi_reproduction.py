...
# Change path- and filenames below according to settings in recalculate_original_omi.py
...
# The following file is included in the source package
original_omi_explained_variance_file = Path(os.path.abspath('')).parents[0] / "tests" / "testdata" / "OriginalOMI" / "omi_var.txt"

# Files with recalculated values (These files will be generated by the example recalculate_original_omi.py):
# The EOFs
